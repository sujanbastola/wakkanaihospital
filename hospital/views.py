...
def paymentcancel(request):
    return render(request, 'hospital/paymentcancel.html')
...
def search(request):
    ...
    return render(request, 'hospital/search.html', params)
...
#         post = post.first()
#     context = {'post': post}
#     return render(request, 'hospital/blogpost.html', context)
...
def post1_view(request):
    return render(request,'hospital/post1.html')


def post2_view(request):
    return render(request,'hospital/post2.html')
